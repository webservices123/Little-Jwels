      ...
      <div className="testimonals-wrapper">
        ...
        <div className="card-testimonals">
          <p>
            ...
            when my elder daughter, Mishka Singh took admission in U.KG. and now
            my son is studying in this school. I want to say that I am very
            happy and satisfied to get my kids admitted at Little Jewels
            Kindergarten. I must say that the administration of the school
            handles each query of all the parents very well. Also, kudos to all
            the teachers for their patience and co-operation they show during
            the online classes. Thanking You!
          </p>
          <section className="parents-corner">
            <h2 className="parents-review">
              {/* <div className="border-style"></div> */}
        ...
        <div className="card-testimonals">
          <p>
            ...
            and grounded as well. A big thumbs up to the complete team of little
            jewels.
          </p>
          <section className="parents-corner">
            <h2 className="parents-review">
        ...
        <div className="card-testimonals">
          ...
          <section className="parents-corner">
            <h2 className="parents-review">
              {/* <div className="border-style"></div> */}
              <p className="parents-name">Mrs. Harsha Godhani</p>
            </h2>
          </section>
          <h4 className="parents-name__description">
            Mother of Devarsh Godhani – L.KG. (2020-21)
          </h4>
        </div>
      </div>
    </>
